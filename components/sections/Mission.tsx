  ...
  return (
    <section id="about" className="bg-paper py-24 text-ink">
      <Container className="grid items-start gap-14 md:grid-cols-[0.9fr_1.6fr]">
        <div className="font-display text-[clamp(80px,10vw,150px)] font-black leading-[0.82] tracking-[-0.04em]">
          01
        </div>
        <p className="font-serif text-[clamp(28px,3vw,42px)] font-normal leading-[1.18] tracking-[-0.02em]">
