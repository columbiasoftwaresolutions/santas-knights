...
export const pillars: {
...
}[] = [
  {
    ...
    body: "Every December, kids write to Santa. We remove identifying details, post the wishes, and help people send the gifts directly.",
    cta: "How it works",
    href: "/letters",
  ...
  },
  {
    ...
    body: "We teach armored combat and fitness in Harlem at no cost, beginners welcome. Browse the six free Gladiators NYC programs and reserve a spot on the training site.",
    cta: "See the classes",
    href: TRAINING_HREF,
